...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower()=="examresults":
            urlpatterns.extend(
                  [
        ...
        if tableName.lower() == "examresults":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/averagescore'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_averagescore".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "examresults":
            urlpatterns.extend(
...
#预测
        if tableName.lower() == "examresultsforecast1":
            urlpatterns.extend(
                       [
...
#预测
        if tableName.lower() == "examresultsforecast":
            urlpatterns.extend(
                       [
                        path(r'{}/forecastimgs'.format(tableName.lower()),eval("{}_v.{}_forecastimgs".format(tableName.capitalize(), tableName.lower()))),
                        path(r'{}/forecast'.format(tableName.lower()),eval("{}_v.{}_forecast".format(tableName.capitalize(), tableName.lower()))),
