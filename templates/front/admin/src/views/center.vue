<template>
	<div :style='{"padding":"60px 20px","margin":"0","fontSize":"15px"}'>
		<el-form
			...
			label-width="180px"
		>
				<el-form-item :style='{"border":"1px solid #CBCBCB","padding":"0","background":"#fff","flexDirection":"row","display":"block","width":"100%","justifyContent":"flex-start"}'   v-if="flag=='xuesheng'"  label="学号" prop="studentid">
					<el-input v-model="ruleForm.studentid" readonly						placeholder="学号" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"1px solid #CBCBCB","padding":"0","background":"#fff","flexDirection":"row","display":"block","width":"100%","justifyContent":"flex-start"}'   v-if="flag=='xuesheng'"  label="学生姓名" prop="xueshengxingming">
					<el-input v-model="ruleForm.xueshengxingming" 						placeholder="学生姓名" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"1px solid #CBCBCB","padding":"0","background":"#fff","flexDirection":"row","display":"block","width":"100%","justifyContent":"flex-start"}' v-if="flag=='xuesheng'" label="头像" prop="touxiang">
					<file-upload
						tip="点击上传头像"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"1px solid #CBCBCB","padding":"0","background":"#fff","flexDirection":"row","display":"block","width":"100%","justifyContent":"flex-start"}' v-if="flag=='xuesheng'"  label="性别" prop="xingbie">
				...
				<el-form-item :style='{"border":"1px solid #CBCBCB","padding":"0","background":"#fff","flexDirection":"row","display":"block","width":"100%","justifyContent":"flex-start"}'   v-if="flag=='xuesheng'"  label="手机号码" prop="shoujihaoma">
...
export default {
	...
	methods: {
		...
		onUpdateHandler() {
			if((!this.ruleForm.studentid)&& 'xuesheng'==this.flag){
