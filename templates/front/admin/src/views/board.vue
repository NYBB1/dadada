		...
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"20%","padding":"15px","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="examresultsChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"padding":"15px","margin":"0 20px","flexWrap":"wrap","flexDirection":"row","flex":"auto","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","width":"0"}'>
				...
				<div :style='{"alignContent":"center","padding":"0 0 20px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"100px"}'>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250107/1f7eba19214f45b0927b3bd789f47556.png) no-repeat center / 100% 100%","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","justifyContent":"space-evenly","height":"78px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"24px"}'>考试成绩总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(52, 171, 255)","fontWeight":"bold","order":"20"}'>{{examresultsCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<el-table id="examresultsTable" :data="examresultsList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="studentid" label="学号">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="timeofenrollment" label="入学时间">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="examtime" label="考试时间">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="totalscore" label="总成绩">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="averagescore" label="平均成绩">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="attendancerate" label="出勤率">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="homeworkcompletionrate" label="作业完成度">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="learningattitude" label="学习态度">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="teachingmethod" label="教学方法">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="grade" label="等级">
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexDirection":"row","display":"flex","transition":"0.3s","justifyContent":"flex-start","flexWrap":"wrap","background":"none","flex":"0 0 auto","gap":"8px","width":"33.33%","height":"calc(40% - 50px)","order":"20"}'>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						...
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.studentid" placeholder="请输入学号"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							政治成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.politicalachievements" placeholder="请输入政治成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							语文成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.chinesescores" placeholder="请输入语文成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							数学成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.mathematicsgrades" placeholder="请输入数学成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							外语成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.foreignlanguagescore" placeholder="请输入外语成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							物理成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.achievement" placeholder="请输入物理成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							化学成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.chemistrygrades" placeholder="请输入化学成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							地理成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.geographyscore" placeholder="请输入地理成绩"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(50% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							历史成绩
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.historicalachievements" placeholder="请输入历史成绩"></input>
					</div>
			...
			<div :style='{"padding":"15px","flexWrap":"wrap","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px","width":"20%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="examresultsChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="examresultsChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		...
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.getexamresultsCount();
					this.examresultsChat1();
					this.examresultsChat2();
					this.examresultsChat3();
					this.examresultsChat4();
					this.examresultsChat5();
					this.examresultsChat6();
					this.examresultsChat7();
					this.examresultsChat8();
				},500)
			})
		},
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'examresultsforecast1/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'examresultsforecast1/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			getexamresultsList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.examresultsList = data.data.list;
						let div = document.getElementById('examresultsTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.examresultsTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.examresultsTimer);
						})
			...
			getexamresultsCount() {
				this.$http({
					url: `examresults/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.examresultsCount = data.data
					}
				})
			},
			//统计接口1
			examresultsChat1() {
				this.$nextTick(()=>{
					...
					var examresultsChart1 = echarts.init(document.getElementById("examresultsChart1"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart1.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat2() {
				this.$nextTick(()=>{
					...
					var examresultsChart2 = echarts.init(document.getElementById("examresultsChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat3() {
				this.$nextTick(()=>{
					...
					var examresultsChart3 = echarts.init(document.getElementById("examresultsChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat4() {
				this.$nextTick(()=>{
					...
					var examresultsChart4 = echarts.init(document.getElementById("examresultsChart4"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat5() {
				this.$nextTick(()=>{
					...
					var examresultsChart5 = echarts.init(document.getElementById("examresultsChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat6() {
				this.$nextTick(()=>{
					...
					var examresultsChart6 = echarts.init(document.getElementById("examresultsChart6"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat7() {
				this.$nextTick(()=>{
					...
					var examresultsChart7 = echarts.init(document.getElementById("examresultsChart7"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							examresultsChart7.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								examresultsChart7.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			examresultsChat8() {
				this.$nextTick(()=>{
					...
					this.$http({
						url: "group/examresults/teachingmethod",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							var option = {};
							this.wordclouds(pArray,'examresultsChart8');
